...
OUTPUT_PATH="${1:-$ROOT_DIR/benchmarks/results/qwen35_cuda_shortlist_large_context_quality_tail.jsonl}"
...
"$ROOT_DIR/.venv/bin/python" "$ROOT_DIR/scripts/run_qwen35_cuda_shortlist_probe.py" \
  ...
  --evaluation-prompt-suite-name qwen35_cuda_shortlist_large_context_quality_tail_synthetic \
