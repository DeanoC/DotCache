...
- Move sketch generation out of preload/append hot paths, or compute/store it earlier.
- Replace heuristic summary scoring with a stronger exact compressed-domain key-side shortlist stage.
