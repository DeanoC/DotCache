...
pub struct LinearAttentionCoreTrace {
    ...
    pub fp32_reference_post_conv_mixed_qkv: StateBuffer,
    pub prepared_query: StateBuffer,
    pub prepared_key: StateBuffer,
    pub prepared_value: StateBuffer,
    pub prepared_beta: StateBuffer,
    pub prepared_g: StateBuffer,
    pub flat3d_weighted_k: StateBuffer,
    pub torch_like_weighted_k: StateBuffer,
    pub flat3d_attn: StateBuffer,
    pub torch_like_attn: StateBuffer,
    pub flat3d_k_cumdecay: StateBuffer,
    pub torch_like_k_cumdecay: StateBuffer,
    pub flat3d_single_chunk_v_new: StateBuffer,
    pub torch_like_single_chunk_v_new: StateBuffer,
    pub flat3d_single_chunk_output: StateBuffer,
    pub torch_like_single_chunk_output: StateBuffer,
    pub focused_recurrent_kv_mem_steps: Vec<StateBuffer>,
    pub focused_recurrent_delta_steps: Vec<StateBuffer>,
    pub focused_recurrent_state_steps: Vec<StateBuffer>,
    pub focused_recurrent_output_steps: Vec<StateBuffer>,
    pub focused_recurrent_kv_mem: StateBuffer,
    ...
    pub fp32_reference_post_conv_value_focus_head: StateBuffer,
