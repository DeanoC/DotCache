...
use super::frontend::{
    build_prepared_embedding_source, build_prepared_linear_source_no_bias,
    debug_full_prefill_kernel_compare_enabled, deferred_in_proj_qkv_enabled,
    immutable_embedding_enabled, immutable_linear_enabled, max_abs_delta, prepared_linear_b,
    prepared_linear_no_bias, profile_elapsed, profile_start, repeat_heads, EmbeddingSource,
    LinearSource, Mlp, OutputProjectionSource, Qwen35RmsNorm, Qwen35RmsNormGated,
    RotaryEmbedding,
};
#[cfg(any(feature = "hf", test))]
...
pub use super::types::{
    CacheState, Config, ExternalFullAttention, ExternalFullAttentionOutput,
    FullAttentionCacheState, LayerCacheState, LinearAttentionBenchResult,
    LinearAttentionCacheState, LinearAttentionLayerSpec, LinearAttentionTrace,
    NativeCacheState, NativeFullAttentionCacheState, NativeLayerCacheState,
    NativeLinearAttentionCacheState, RopeParameters, RuntimeProfile, StateBuffer, TextConfig,
};
#[cfg(any(feature = "hf", test))]
...
pub(crate) use super::hip_wrappers::{
    ...
    linear_attention_chunk_size, linear_attention_compute_dtype, softplus,
