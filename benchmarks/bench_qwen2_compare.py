...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Compare dense KV vs DotCache on one loaded Qwen2-family model.")
...
def main() -> None:
    ...
    harness = Qwen2DotCacheHarness.from_pretrained(
        args.model_id,
        dotcache_config,
