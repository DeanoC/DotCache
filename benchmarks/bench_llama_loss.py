...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Teacher-forced loss comparison for dense vs DotCache on one loaded Llama-family model.")
...
def main() -> None:
    ...
    if not transformers_available():
        raise SystemExit("bench_llama_loss.py requires the optional transformers dependencies")
