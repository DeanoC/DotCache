...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Capture-only benchmark for the Qwen3.5 full-attention subset.")
...
def _run_case(
    ...
    *,
    ...
    try:
        ...
        error_record.update(
            {
                "benchmark": "qwen35_attention_subset",
                "status": "error",
...
def main() -> None:
    ...
    if not transformers_available():
        raise SystemExit("bench_qwen35_attention_subset.py requires the optional transformers dependencies")
