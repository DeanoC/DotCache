...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Inspect Qwen3.5 hybrid text-state layout and DotCache-fit hints.")
...
def main() -> None:
    ...
    if not transformers_available():
        raise SystemExit("bench_qwen35_hybrid_inspect.py requires the optional transformers dependencies")
